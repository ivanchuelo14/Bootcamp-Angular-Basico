// To parse this data:
//
//   import { Convert, IAnimap } from "./file";
//
//   const iAnimap = Convert.toIAnimap(json);
//
// These functions will throw an error if the JSON doesn't
// match the expected interface, even if the JSON is valid.

export interface IAnimap {
    data:       DataMap[];
    meta:       Meta;
...
export class Convert {
    public static toIAnimap(json: string): IAnimap {
        return cast(JSON.parse(json), r("IAnimap"));
    }

    public static iAnimapToJson(value: IAnimap): string {
        return JSON.stringify(uncast(value, r("IAnimap")), null, 2);
    }
}
